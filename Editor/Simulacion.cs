                ...
                for (int k = 1; k < tamanio.z - 1; k++)
                {
                    ...
                    for (int w = 0; w < 3; w++)
                    {
                        ...
                        else
                        {
                            ...
                            float velocidadAnterior = datosAnteriores[(uint)i, (uint)j, (uint)k].Velocidad[w];
                            dato.Velocidad[w] = velocidadAnterior - (valoresDeP[indexAdelante, 0] -valoresDeP[indexAtras, 0]) / 2;
                        }
                    }
